...
(function(){
  ...
  theme.AjaxRenderer = (function () {
    ...
    AjaxRenderer.prototype = Object.assign({}, AjaxRenderer.prototype, {
      renderPage: function (basePath, newParams, collectionHandle, updateURLHash = true) {
        const currentParams = new URLSearchParams(window.location.search);
        const updatedParams = this.getUpdatedParams(currentParams, newParams);
        basePath = `/collections/${collectionHandle}/`;
  ...
  theme.Collection = (function() {
    ...
    Collection.prototype = Object.assign({}, Collection.prototype, {
      ...
      renderCollectionPage: function(searchParams, updateURLHash = true) {
        this.ajaxRenderer
          .renderPage(window.location.pathname, searchParams, this.collectionHandle, updateURLHash)
          .then(() => {
  ...
  theme.Product = (function() {
    ...
    Product.prototype = Object.assign({}, Product.prototype, {
      ...
      cacheElements: function() {
        let forms = this.container.querySelectorAll(this.selectors.form);
